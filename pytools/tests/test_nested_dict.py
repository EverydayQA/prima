...
class TestNestedDict(unittest.TestCase):
    ...
    def test_set(self):
        ...
        dnew = self.nd.set('topless', *[u'0002', u'topping', u'5001', u'type'],  **dcopy)

        value = self.nd.get(*[u'0002', u'topping', u'5001'], **dnew)
        ...
        # int key
        dcopy = copy.deepcopy(self.dfood)
        dnew = self.nd.set('topless', *['35', 'topping', '5001', 'type'],  **dcopy)
        pprint(dnew)
        argv = ['35', 'topping', '5001']
        value = self.nd.get(*argv, **dnew)
    ...
    def test_deep_keys(self):
        ...
        source = {'hello1': 1}
        keys = []
        keys = self.nd.deep_keys(keys, **source)
    ...
    def test_merge_shallow(self):
        ...
        d = self.nd.merge_shallow(overrides, **source)
