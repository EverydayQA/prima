import mock
from other.fsample import person
import unittest
...
class TestPerson(unittest.TestCase):
    ...
    @mock.patch('other.fsample.person.get_name')
    """
    ...
    @mock.patch('other.fsample.person.Pet')
    ...
    @mock.patch('other.fsample.person.noise_logger', lambda x: x)
