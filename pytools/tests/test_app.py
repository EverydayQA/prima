import mock
from nose_tests.fsample.app import App
from nose_tests.fsample.app import Base
import unittest
...
class TestApp(unittest.TestCase):
    ...
    def test_mock_instance_var_2(self):
        ...
        # AttributeError: <class 'nose_tests.fsample.app.Base'> does not have the attribute 'instance_var'
        # with mock.patch.object(Base, 'instance_var') as mock_instance_var:
        # with mock.patch('nose_tests.fsample.app.Base.instance_var') as mock_attr:
        This test will failed, and kept to show the scope is only in Base class, not App unless using self.ibase = base
        """

        patcher = mock.patch('nose_tests.fsample.app.Base')
    ...
    def test_instance4(self, mock_stdout):
        ...
        """
        with mock.patch('nose_tests.fsample.app.Base') as mock_base:
    ...
    def test_instance3(self, mock_stdout):
        ...
        """
        with mock.patch('nose_tests.fsample.app.Base', autospec=True, spec_set=None) as mock_base:
    ...
    def test_cls_attr2(self):
        ...
        """
        with mock.patch('nose_tests.fsample.app.Base', cls_attr='mocked', autospec=True) as mock_Base:
    ...
    def test_cls_property_with_property_mock(self):
        ...
        these will not work
        patch.object('nose_tests.fsample.app.Base')
        patch('nose_tests.fsample.app.Base')
        """
    ...
    def test_cls_property_with_property_mock2(self):
        """
        """
        with mock.patch('nose_tests.fsample.app.Base.cls_property', new_callable=mock.PropertyMock) as mock_cls_property:
    ...
    @mock.patch('nose_tests.fsample.app.Base.static_add')
