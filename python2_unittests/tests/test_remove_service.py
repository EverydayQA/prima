from python2_unittests.lib import remove_service
import mock
import unittest
...
class TestRemovalService(unittest.TestCase):
    ...
    @mock.patch('python2_unittests.lib.remove_service.os.path')
    @mock.patch('python2_unittests.lib.remove_service.os')
    ...
    @mock.patch('python2_unittests.lib.remove_service.hasattr')
